...
class CovidController extends Controller
{
    ...
    {
        $ProductData = order_items::where('product_id', $request->product)
        ...
        $product = products::where('id', $request->product)->first()->name;
        //$productName = $product ? $product->name : null;


        // return the as a JSON

        return response()->json(['product' => $product, 'ProductData' => $ProductData]);
    }
