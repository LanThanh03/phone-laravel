        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="hero__search">
              ...
              <form id="search-form" action="{{ route('search') }}" method="POST" onSubmit="handleSearch(event)">
                  @csrf
                  <input type="text" id="search-input" placeholder="What do you need?" name="keyword" />
